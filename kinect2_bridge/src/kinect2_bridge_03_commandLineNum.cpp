...
//
	...
	if(addCount == NUMOFDEPTH){
	  ...
	  cv::Canny(addDepth_8U, addDepth_Canny02, 175, 10);


	  //cv::Canny(addDepth_8U, addDepth_Canny03, 150, 10);
	  //cv::Canny(addDepth_8U, addDepth_Canny04, 175, 10);
	  //cv::Canny(addDepth_8U, addDepth_Canny05, 200, 10);
	  ...
	  //sprintf(str3, "clothEdgeDataSet/edgeC%s.png", PATTERN);
	  //sprintf(str4, "clothEdgeDataSet/edgeD%s.png", PATTERN);
	  //sprintf(str5, "clothEdgeDataSet/edgeE%s.png", PATTERN);
